...
def main():
    ...
    sn = sn -1
    print(f"Count of DR_MAPE<LR_MAPE is {count_MAPE} , results of {round(count_MAPE/sn*100)}% are better")
    print(f"Count of DR_MAPE<LR_MAPE is {count_MAE} , results of {round(count_MAE/sn*100)}% are better")
    print(f"Count of DR_MAPE<LR_MAPE is {count_RMSE} , results of {round(count_RMSE/sn*100)}% are better")
